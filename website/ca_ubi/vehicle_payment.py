...
def set_parameters(parameters):
    parameters.states.ca.per_vehicle_payment.amount.CA.update(
        value=400, period="year:2022:1"
    )
    parameters.states.ca.per_vehicle_payment.max_vehicles.CA.update(
        value=2, period="year:2022:1"
    )
    return parameters
