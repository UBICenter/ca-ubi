...
class vehicle_subsidy_payment(Variable):
    value_type = float
    entity = SPMUnit
...
class spm_unit_is_in_spm_poverty(Variable):
    ...
    def formula(spm_unit, period, parameters):
        income = spm_unit("spm_unit_net_income", period) + spm_unit("vehicle_subsidy_payment", period)
...
class vehicle_subsidy(Reform):
    def apply(self):
        ...
        self.add_variable(vehicle_subsidy_payment)